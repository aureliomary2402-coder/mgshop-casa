...
export default function WelcomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden"
      style={{ background: 'linear-gradient(135deg,#0a0a0b 0%,#1c1c1f 40%,#27272a 70%,#1c1c1f 100%)' }}>
        ...
        {[
          ...
          <div key={i} className="absolute rounded-full animate-bubble-rise"
            style={{
              ...
              boxShadow: 'inset -4px -4px 10px rgba(255,255,255,0.35), inset 3px 3px 8px rgba(100,116,139,0.15), 0 0 14px rgba(150,235,250,0.12)',
      ...
      <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: 'linear-gradient(rgba(148,163,184,0.8) 1px,transparent 1px),linear-gradient(90deg,rgba(148,163,184,0.8) 1px,transparent 1px)', backgroundSize: '60px 60px' }} />
      ...
      <div className={`relative z-10 text-center px-6 max-w-2xl mx-auto ${mounted ? 'animate-bubble-reveal' : 'opacity-0'}`}>
        <div className="mb-10">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl mb-6 animate-float"
            style={{ background: 'linear-gradient(135deg,#0891b2,#06b6d4)', boxShadow: '0 20px 60px rgba(100,116,139,0.5)' }}>
          ...
          <p className="text-xl text-slate-200/40 tracking-[0.3em] uppercase font-light">Casa</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
          <Link href="/shop"
            ...
            style={{ background: 'linear-gradient(135deg,#0891b2,#06b6d4)', boxShadow: '0 16px 40px rgba(100,116,139,0.4)' }}>
          ...
          {promoActive ? (
            <Link href="/promo"
              ...
              style={{ background: 'rgba(100,116,139,0.1)', border: '1px solid rgba(100,116,139,0.3)', color: '#06b6d4' }}>
        ...
        <div className="flex items-center justify-center gap-8 mt-10">
          {[['400+', 'Prodotti'], ['⭐⭐⭐⭐⭐', 'Qualità'], ['🚚', 'Consegna rapida']].map(([v, l]) => (
            <div key={l} className="text-center">
              ...
              <div className="text-xs text-slate-200/30 mt-1">{l}</div>
            </div>
          ))}
        </div>
      </div>
