...
import { SOCIAL_LINKS, WHATSAPP_NUMBER, InstagramIcon, TikTokIcon, WhatsAppIcon, FacebookIcon } from '@/components/shop/social-icons'
...
const SOCIALS = [
  ...
  },
  {
    ...
    description: 'Scrivici direttamente in chat per ordini e informazioni.',
  ...
  },
  {
    key: 'facebookPage',
    name: 'Facebook',
    handle: 'Pagina ufficiale',
    description: 'La pagina ufficiale del negozio: novità ed eventi.',
