...
const TABS = [
  ...
  { id: 'products' as Tab, label: 'Prodotti', icon: Package, color: 'text-cyan-600 bg-cyan-50' },
  ...
  { id: 'orders' as Tab, label: 'Ordini', icon: ShoppingBag, color: 'text-sky-600 bg-sky-50' },
  ...
  { id: 'fedelta' as Tab, label: 'Fedeltà', icon: Gift, color: 'text-teal-600 bg-teal-50' },
