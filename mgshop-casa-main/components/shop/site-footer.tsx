...
export function SiteFooter() {
  ...
  return (
    <footer className="relative overflow-hidden mt-10 pb-24 md:pb-10"
      style={{ background: 'linear-gradient(135deg,#041C33 0%,#0B3C65 55%,#041C33 100%)' }}>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-12 pb-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-lg font-bold text-white tracking-tight">
                MG<span style={{ color: '#97C3EE' }}>Shop</span>
              </span>
            </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-2.5">
              <a href={SOCIAL_LINKS.instagram} target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                ...
                style={{ background: 'rgba(217,70,160,0.15)', border: '1px solid rgba(217,70,160,0.3)', color: '#E58DA7' }}>
        ...
        <div className="mt-10 pt-6 flex flex-col sm:flex-row items-center justify-center gap-1.5 text-xs text-cyan-200/40"
          ...
          <span className="flex items-center gap-1.5">
            <Heart className="w-3 h-3 text-pink-400" style={{ fill: '#E58DA7' }} />
