...
// banner attivo (gestibile da admin). Stesso stile scuro (theme-hero-dark,
// bolla vetro centrata, badge, titolo shimmer) delle altre pagine vetrina
// (volantino, promo, lotteria, consegne) cosi' il banner e' coerente
// ovunque nel sito: cambia solo l'icona/colore e il testo del banner.
