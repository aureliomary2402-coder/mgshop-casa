    ...
    <header className="sticky top-0 z-50"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        <Link href="/" className="flex items-center shrink-0 select-none">
          <span className="hidden md:inline text-xl font-extrabold tracking-tight" style={{ color: '#041C33' }}>
            MG <span style={{ color: '#2578A4' }}>SHOP</span>
          </span>
          <span className="md:hidden flex flex-col items-center leading-none">
            <span className="text-xl font-extrabold tracking-tight" style={{ color: '#041C33' }}>MG</span>
            <span className="text-[10px] font-bold tracking-[0.35em]" style={{ color: '#2578A4' }}>SHOP</span>
          </span>
        </Link>
