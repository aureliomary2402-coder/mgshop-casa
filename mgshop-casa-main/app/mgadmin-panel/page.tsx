    ...
    <div className="min-h-screen flex items-center justify-center px-4" style={{ background: 'linear-gradient(180deg,#EDF5FD 0%,#F7FBFF 45%,#ffffff 100%)' }}>
      <div className="bg-white rounded-2xl shadow-md p-8 w-full max-w-sm" style={{ border: '1px solid rgba(8,145,178,0.1)' }}>
        <div className="flex justify-center mb-6">
          <div className="w-14 h-14 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #2578A4, #97C3EE)' }}>
            <Lock className="w-7 h-7 text-white" />
          </div>
        </div>
        <h1 className="text-xl font-bold text-center mb-6" style={{ color: '#041C33' }}>Accesso Admin</h1>
    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(180deg,#EDF5FD 0%,#F7FBFF 45%,#ffffff 100%)' }}>
      <div className="bg-white border-b px-4 h-14 flex items-center justify-between sticky top-0 z-40" style={{ borderColor: 'rgba(8,145,178,0.1)' }}>
        <div className="flex items-center gap-3">
          <button onClick={() => setMenuOpen(v => !v)} className="w-9 h-9 flex items-center justify-center rounded-xl hover:bg-cyan-50 transition-colors" style={{ color: '#2578A4' }}>
        ...
        <div className="flex items-center gap-2">
          <PushNotifications />
          <Link href="/shop" target="_blank" className="flex items-center gap-1 text-xs font-medium px-3 py-1.5 rounded-lg transition-colors hover:bg-cyan-50" style={{ color: '#2578A4', border: '1px solid rgba(8,145,178,0.2)' }}>
          ...
          <div className="relative w-72 max-w-[85vw] bg-white h-full shadow-2xl flex flex-col animate-slide-in-left">
            <div className="p-5 border-b border-slate-100">
              <div className="flex items-center justify-between mb-1">
                <span className="font-bold text-slate-800">MG<span style={{ color: '#2578A4' }}>Shop</span> Admin</span>
            ...
            <div className="p-4 border-t border-slate-100 space-y-2">
              <Link href="/shop" target="_blank" onClick={() => setMenuOpen(false)} className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors hover:bg-cyan-50" style={{ color: '#2578A4' }}>
                <div className="w-8 h-8 rounded-lg flex items-center justify-center" style={{ background: 'rgba(8,145,178,0.1)' }}><ExternalLink className="w-4 h-4" style={{ color: '#2578A4' }} /></div>
                Vai al negozio
              </Link>
