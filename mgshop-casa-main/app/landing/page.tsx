...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ background: 'linear-gradient(135deg, #04202b 0%, #06303d 30%, #0c2b36 60%, #03131a 100%)' }}>
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto pt-16">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
            <Link href="/"
              ...
              style={{ background: 'linear-gradient(135deg, #0891b2, #06b6d4)', color: '#ffffff', boxShadow: '0 20px 40px rgba(8,145,178,0.4)' }}>
              Scopri i prodotti
      ...
      {/* Features */}
      <section className="relative py-28 px-6" style={{ background: 'linear-gradient(180deg, #0c2b36 0%, #03131a 100%)' }}>
      ...
      {/* CTA */}
      <section className="relative py-28 px-6 overflow-hidden" style={{ background: 'linear-gradient(135deg, #03131a 0%, #0c2b36 50%, #03131a 100%)' }}>
        <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <Link href="/"
            ...
            style={{ background: 'linear-gradient(135deg, #0891b2, #06b6d4)', color: '#ffffff', boxShadow: '0 25px 50px rgba(8,145,178,0.5)' }}>
