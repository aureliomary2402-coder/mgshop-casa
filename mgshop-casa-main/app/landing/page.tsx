...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ background: 'linear-gradient(135deg, #041C33 0%, #041C33 30%, #041C33 60%, #041C33 100%)' }}>

      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 md:px-12 h-16 glass-dark border-b border-cyan-900/20">
        <span className="text-lg font-bold tracking-tight text-white">MG<span className="text-shimmer">Shop</span> Casa</span>
        <Link href="/" className="flex items-center gap-2 bg-gradient-to-r from-cyan-500 to-sky-500 hover:from-cyan-400 hover:to-sky-400 text-white font-semibold text-sm px-5 py-2.5 rounded-full transition-all hover:scale-105 active:scale-95 shadow-lg shadow-cyan-500/30 btn-press">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] rounded-full blur-[100px] opacity-20"
            style={{ background: 'radial-gradient(circle, #2578A4, #0B3C65)', transform: `translate(${mousePos.x * -30}px, ${mousePos.y * -20}px)`, transition: 'transform 0.8s ease' }} />
          <div className="absolute bottom-1/3 right-1/4 w-[400px] h-[400px] rounded-full blur-[80px] opacity-15"
            style={{ background: 'radial-gradient(circle, #97C3EE, #2578A4)', transform: `translate(${mousePos.x * 20}px, ${mousePos.y * 15}px)`, transition: 'transform 1s ease' }} />
          <div className="absolute top-1/2 right-1/3 w-[300px] h-[300px] rounded-full blur-[60px] opacity-10"
            style={{ background: 'radial-gradient(circle, #97C3EE, #2578A4)', transform: `translate(${mousePos.x * -15}px, ${mousePos.y * 25}px)`, transition: 'transform 1.2s ease' }} />
        </div>
        ...
        <div className="absolute top-24 right-6 md:right-24 hidden lg:block"
          ...
          <div className="w-44 h-56 rounded-2xl border border-cyan-500/20 p-4 flex flex-col justify-between animate-float"
            style={{ background: 'linear-gradient(135deg, rgba(8,145,178,0.15), rgba(21,94,117,0.1))', backdropFilter: 'blur(10px)' }}>
            <div className="w-full h-28 rounded-xl bg-cyan-500/10 flex items-center justify-center">
              <Package className="w-10 h-10 text-cyan-400/50" />
            </div>
            <div className="space-y-1.5">
              <div className="h-2 bg-cyan-400/20 rounded-full w-3/4" />
              <div className="h-2 bg-cyan-400/15 rounded-full w-1/2" />
              <div className="h-4 bg-cyan-500/30 rounded-full w-1/3 mt-2" />
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-32 left-6 md:left-24 hidden lg:block"
          ...
          <div className="w-36 h-44 rounded-2xl border border-sky-500/20 p-3 flex flex-col justify-between animate-float-slow"
            style={{ background: 'linear-gradient(135deg, rgba(14,165,233,0.12), rgba(8,145,178,0.08))', backdropFilter: 'blur(10px)' }}>
            <div className="w-full h-22 rounded-xl bg-sky-400/10 flex items-center justify-center h-24">
              <Heart className="w-8 h-8 text-sky-400/40" />
            </div>
            <div className="space-y-1">
              <div className="h-2 bg-sky-400/20 rounded-full w-full" />
              <div className="h-2 bg-sky-400/15 rounded-full w-2/3" />
              <div className="h-3 bg-sky-500/25 rounded-full w-1/2 mt-1" />
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto pt-16">
          <div className="inline-flex items-center gap-2 border border-cyan-500/30 rounded-full px-5 py-2 text-cyan-300 text-sm font-medium mb-10 animate-fade-in"
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.2s', animationFillMode: 'both' }}>
            <Link href="/"
              ...
              style={{ background: 'linear-gradient(135deg, #2578A4, #97C3EE)', color: '#ffffff', boxShadow: '0 20px 40px rgba(8,145,178,0.4)' }}>
              Scopri i prodotti
              <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link href="/carrello"
              className="flex items-center gap-2 text-cyan-200/70 hover:text-cyan-100 border border-cyan-500/20 hover:border-cyan-500/40 px-8 py-5 rounded-2xl transition-all hover:bg-cyan-500/5">
        ...
        {/* Scroll indicator */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-cyan-500/40">
          <div className="w-5 h-8 border border-cyan-500/30 rounded-full flex items-start justify-center p-1">
            <div className="w-1 h-2 bg-cyan-400/60 rounded-full animate-scroll-indicator" />
          </div>
        </div>
      </section>

      {/* Features */}
      <section className="relative py-28 px-6" style={{ background: 'linear-gradient(180deg, #041C33 0%, #041C33 100%)' }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-20">
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-4">
              Perché scegliere <span className="text-shimmer">MGShop Casa</span>?
            </h2>
            <p className="text-cyan-200/40 text-lg">Qualità, convenienza e un servizio che senti vicino</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              { icon: Truck, title: 'Consegna rapida', desc: 'Ordini gestiti personalmente. Ti contattiamo su WhatsApp per confermare.', gradient: 'from-sky-600/20 to-sky-900/10', border: 'border-sky-500/20', iconBg: 'bg-sky-500/20', iconColor: 'text-sky-400' },
      ...
      {/* CTA */}
      <section className="relative py-28 px-6 overflow-hidden" style={{ background: 'linear-gradient(135deg, #041C33 0%, #041C33 50%, #041C33 100%)' }}>
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] rounded-full blur-[80px] opacity-20"
            style={{ background: 'radial-gradient(ellipse, #2578A4, transparent)' }} />
        </div>
        <div className="relative z-10 max-w-3xl mx-auto text-center">
          ...
          <Link href="/"
            ...
            style={{ background: 'linear-gradient(135deg, #2578A4, #97C3EE)', color: '#ffffff', boxShadow: '0 25px 50px rgba(8,145,178,0.5)' }}>
      ...
      {/* Footer */}
      <footer className="border-t border-cyan-900/20 py-8 px-6 text-center" style={{ background: '#041C33' }}>
