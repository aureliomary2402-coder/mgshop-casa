...
export function BackToTop() {
  ...
  return (
    <button
      ...
      aria-label="Torna su"
      className="fixed bottom-12 left-5 z-40 w-11 h-11 rounded-full flex items-center justify-center btn-press transition-all duration-300"
      style={{
        background: 'white',
      ...
      <ArrowUp className="w-5 h-5" style={{ color: '#0891b2' }} />
    </button>
  )
}
