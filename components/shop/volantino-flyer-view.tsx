...
// Griglia di un volantino già caricato (dati + prodotti risolti). Usata sia
// da /volantino (quando c'è un solo volantino attivo, per compatibilità con
// link/QR/catalogo già condivisi) sia da /volantino/[slug].
    ...
    <div className="min-h-screen" style={{ background: 'linear-gradient(180deg,#eafbff 0%,#f5fdff 45%,#ffffff 100%)' }}>
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 py-10">
          {showBackToList && (
            <Link href="/volantino" className="inline-flex items-center gap-1.5 text-sm font-medium mb-4" style={{ color: '#0891b2' }}>
              <ArrowLeft className="w-4 h-4" /> Tutti i volantini
            </Link>
          )}
          {products.length > 0 ? (
            <Reveal>
